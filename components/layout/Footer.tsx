    ...
    <AnimatePresence>
      {show && (
        <motion.a
          ...
          className="fixed bottom-6 right-6 z-40 w-11 h-11 bg-accent/20 hover:bg-accent/40 text-accent rounded-full flex items-center justify-center transition-colors duration-300 border border-accent/30 backdrop-blur-sm"
